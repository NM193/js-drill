...
export function buildPrompt(format, bank, history, errors = []) {
  return [
    ...
    '- Kod se izvrsava u STRICT modu. Upis u zamrznut objekat baca TypeError umesto da tiho ne uspe, a upis u nedeklarisanu promenljivu takodje baca. Pisi testove u skladu s tim, npr. assert.throws(() => { o.a = 2; }).',
